...
Pod::Spec.new do |s|
  s.name             = "WindowAlert"
  s.version          = "0.1.0"
  s.summary          = "A short description of WindowAlert."
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/WindowAlert.git", :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'WindowAlert' => ['WindowAlert/Assets/*.png']
  # }
